...
import { Login } from '@/shared/constants/login.constants';
...
export default class ForgotPassword extends Vue {
  messageForgotPassword = Login.MESSAGE_FORGOT_PASSWORD;
  nameBtnResetPassword = Login.BUTTON_RESET_PASSWORD;
  email = '';
  isErrorEmail = true;
  emailError = '';
  ...
  async handleResetPassword() {
    if (this.isErrorEmail) {
      this.emailError = Login.MESSAGE_NOTIFY_FORGOT_PASSWORD;
    } else {
