              ...
              <tr>
                ...
                <th v-for="column in value.schema.columns" :key="column.name">
                  <div class="dropdown dropdown-th">
                    <a href="#" class="text-white font-weight-normal dropdown-toggle" data-toggle="dropdown">{{ COLUMN_DATA_TYPE_NAME[column.class_name] }}</a>
        ...
        <div class="form-group form-group-di">
          ...
          <div class="d-flex align-items-center mb-3">
            <label class="di-radio">
              <input v-model="value.setting.include_header" @change="calcPreviewData(false)" :value="true" type="radio" name="header" />
              <span></span>
          ...
          <div class="d-flex align-items-center">
            <label class="di-radio">
              <input v-model="value.setting.include_header" @change="calcPreviewData(false)" :value="false" type="radio" name="header" />
              <span></span>
