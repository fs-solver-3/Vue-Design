              ...
              <template v-slot="{ item, index, active }">
                <DynamicScrollerItem :item="item" :active="active" :data-active="active" :data-index="index">
                  <div class="listing-content" :key="index">
                    <PageView v-if="isDiSessionEvent(item.eventName)" :backgroundColor="currentTheme.primary" :data="item" />
                    <ActivityCard v-else :backgroundColor="currentTheme.primary" :data="item" />
                  </div>
                </DynamicScrollerItem>
              </template>
            </DynamicScroller>
...
import { DefaultPaging, ScrollConfigs, Stores } from '@/shared';
...
export default class Activity extends Vue {
  ...
  dateRange: DateRange;
  scrollOption: Config = ScrollConfigs;
  ...
  mainDateFilterMode = MainDateFilterMode.custom;
...
::v-deep {
  @import '~@/themes/scss/calendar/custom-vcalendar.scss';
