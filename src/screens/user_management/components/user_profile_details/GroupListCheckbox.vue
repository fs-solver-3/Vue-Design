    ...
    <CollapseTransition v-show="isShowListCheckbox" :delay="5000" easing="ease-in-out">
      <div class="list-checkbox">
        <div class="list-checkbox-container">
          <b-form-checkbox class="select-all" v-model="isSelectedAll" :value="true" :unchecked-value="false">
            All
          </b-form-checkbox>
          <MultiSelection
            :id="id"
...
export default class GroupListCheckbox extends Vue {
  ...
  private isSelectedAll = this.selectedItems.includes(this.allCheckboxValue);
