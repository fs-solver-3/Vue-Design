    ...
    >
      <template #extraStep>
        <div class="select-default-time">
          <div @click.prevent="handleBackOnSelectDB" class="back-to-select-db btn-ghost-alter align-items-center">
          ...
          <vuescroll class="vuescroll-select-default-time">
            <div class="dropdown-default-time-container">
              <a
                href=""
                class="default-time-item btn-ghost-alter"
...
export default class SetupMainDateFilter extends Vue {
  ...
  private handleSelectDefaultTime(mainDateFilterMode: MainDateFilterMode) {
  ...
  private get getTitle() {
    if (this.isResetMainDateFilter) {
      return 'Re Setup Main Date Filter';
    }
    return 'Setup Main Date Filter';
  }
}
</script>
