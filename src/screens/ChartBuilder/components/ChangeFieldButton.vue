<template>
  <div>
    <button
      :id="randomId"
      class="display-name btn-ghost-alter text-decoration-none change-field-btn text-nowrap"
      v-b-tooltip.d300.top="fieldDetailInfo"
      @click="handleClickButton"
    >
      {{ title }}
    </button>
    <BPopover :show.sync="isShowPopover" :target="randomId" custom-class="popover-dropdown" placement="bottomright" triggers="blur">
