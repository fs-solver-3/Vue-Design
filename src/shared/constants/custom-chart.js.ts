...
export const CustomJsAsMap = new Map<WidgetType, string>([
  [WidgetType.table, CustomTableJs],
  [WidgetType.line, CustomLineChartJs],
  [WidgetType.column, CustomColumnChartJs],
  [WidgetType.bar, CustomBarChartJs],
  [WidgetType.area, CustomAreaChartJs],
  [WidgetType.kpi, CustomNumberChartJs]
]);
