...
export const CustomCssAsMap = new Map<WidgetType, string>([
  [WidgetType.table, CustomTableCss],
  [WidgetType.line, CustomLinesCss],
  [WidgetType.column, CustomColumnCss],
  [WidgetType.bar, CustomBarCss],
  [WidgetType.area, CustomAreaCss],
  [WidgetType.kpi, CustomNumberCss]
]);
