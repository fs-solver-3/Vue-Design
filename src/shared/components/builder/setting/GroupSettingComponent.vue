...
export default class GroupSettingComponent extends Vue {
  ...
  private get opacity(): string {
    const opacity: number = this.isEnable ? ThemeModule.currentTheme.enableOpacity : ThemeModule.currentTheme.disableOpacity;
  ...
  @MethodProfiler({ prefix: 'VizSettingModal', name: 'handleSettingChanged' })
