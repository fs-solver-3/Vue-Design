...
export class IconFieldValueFormatter implements BodyStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> {
  ...
  private canUseIconRule(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createNormalIcon(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createDefaultIcon(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
