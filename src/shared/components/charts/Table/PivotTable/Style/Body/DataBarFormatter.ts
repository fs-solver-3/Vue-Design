...
import { AbstractTableResponse, ConditionalFormattingData, PivotTableQuerySetting, PivotTableVizSetting } from '@core/domain';
...
export class DataBarFormatter implements BodyStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> {
  private static findConditionalFormattingData(
    bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>
  ...
  private canUseDataBar(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createDataBarStyle(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createDefaultDataBarStyle(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
