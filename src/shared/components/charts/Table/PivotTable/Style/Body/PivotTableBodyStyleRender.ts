...
import { PivotTableQuerySetting, PivotTableVizSetting } from '@core/domain/Model';
...
export class PivotTableBodyStyleRender implements TableBodyStyleRender {
  ...
  private styleFormatters: BodyStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>[];
  ...
  createStyle(bodyCellData: CustomBodyCellData): CustomStyleData {
    const bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> = {
