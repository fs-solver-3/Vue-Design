...
import { AbstractTableResponse, PivotTableQuerySetting, PivotTableVizSetting } from '@core/domain';
...
export class PivotTableFooterStyleRender implements TableFooterStyleRender {
  ...
  private vizSetting: PivotTableVizSetting;
  private baseThemeColor: string;
  private styleFormatters: FooterStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>[];
  ...
  createStyle(cellData: CustomFooterCellData): CustomStyleData {
    const bodyData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> = {
