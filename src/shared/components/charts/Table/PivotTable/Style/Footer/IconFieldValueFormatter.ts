...
export class IconFieldValueFormatter implements FooterStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> {
  ...
  private canUseIconRule(footerData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createPivotIconStyle(bodyData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
  ...
  private createTableIconStyle(bodyData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
