...
export class ColorFieldValueFormatter implements FooterStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting> {
  ...
  createTableColorStyle(bodyData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>): CustomStyleData {
  ...
  private canUseColorFieldValue(bodyData: FooterData<PivotTableQuerySetting, AbstractTableResponse, PivotTableVizSetting>) {
