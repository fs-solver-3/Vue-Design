...
import { FieldFormatter, FieldFormatting, PivotTableQuerySetting, PivotTableVizSetting, TableColumn } from '@core/domain';
import { ListUtils } from '@/utils';
import { StringUtils } from '@/utils/string.utils';
import { PivotFormatAs } from '@chart/Table/PivotTable/Style/PivotFormatAs';

export class PivotFieldFormatterUtils {
  static getFieldFormatter(header: IndexedHeaderData, querySetting: PivotTableQuerySetting, vizSetting: PivotTableVizSetting): FieldFormatter | undefined {
  ...
  private static getPivotFieldFormatter(
    ...
    vizSetting: PivotTableVizSetting
