...
export class DefaultTableBodyStyleRender implements TableBodyStyleRender {
  ...
  private getColorConfigOf(bodyCellData: CustomBodyCellData, tableResponse: AbstractTableResponse, vizSetting: TableVizSetting): ColorConfig | undefined {
