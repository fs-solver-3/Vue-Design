...
export class DataBarFormatter implements BodyStyleFormatter<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting> {
  static createDataBarStyle(
    bodyData:
      | BodyData<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting>
  ...
  private canUseDataBar(bodyData: BodyData<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting>) {
