...
import { AbstractTableQuerySetting, TableVizSetting } from '@core/domain/Model';
...
export class DefaultTableBodyStyleRender2 implements TableBodyStyleRender {
  ...
  private styleFormatters: BodyStyleFormatter<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting>[];
  ...
  createStyle(bodyCellData: CustomBodyCellData): CustomStyleData {
    const bodyData: BodyData<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting> = {
