...
import { AbstractTableQuerySetting, FieldFormatter, FieldFormatting, TableVizSetting } from '@core/domain';
import { StringUtils } from '@/utils/string.utils';
import { ListUtils } from '@/utils';
import { ObjectUtils } from '@core/utils';

export class TableFieldFormatterUtils {
  static getFieldFormatter(header: IndexedHeaderData, querySetting: AbstractTableQuerySetting, vizSetting: TableVizSetting): FieldFormatter | undefined {
