...
export class TableFieldStyleFormatter implements FooterStyleFormatter<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting> {
  createStyle(bodyData: FooterData<AbstractTableQuerySetting, AbstractTableResponse, TableVizSetting>): CustomStyleData {
