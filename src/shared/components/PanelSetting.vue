  ...
  <div class="panel" :class="classChartPreview" @click.stop="handleCollapsePanel">
    <div class="setting-panel d-flex flex-row align-items-start">
      ...
      <div class="d-flex flex-row ml-auto">
        <img class="setting-icon btn-ghost-alter mr-2" src="@/assets/icon/ic_setting.svg" @click.stop="toggleSetting" v-if="isShowSettingIcon && isOpened" />
        <div class="d-flex flex-row setting-icon btn-ghost-alter align-items-center" @click.stop="toggleCollapse">
