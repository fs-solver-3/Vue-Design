<template>
  <div class="field-listing-area">
    ...
    <div
      ...
      :id="genBtnId('data-list-searchable-back')"
      v-if="canBack"
      ...
      <div class="custom-listing">
        <template v-if="haveOptions">
          <div
            ...
            class="d-flex flex-row align-items-center data-item btn-ghost-alter"
          >
...
import { OnlyVerticalScrollConfigs, SelectOption } from '@/shared';
import { ListUtils, SchemaUtils } from '@/utils';

@Component
export default class DataListingSearchable extends Vue {
  scrollOption: Config = OnlyVerticalScrollConfigs;
...
.field-listing-area {
  ...
  .custom-listing {
    ...
    .btn-ghost-alter {
      ...
      &:hover {
        background-color: rgba(#f6f5f5, 0.1);
      }

      &:active {
        background-color: rgba(#f6f5f5, 0.15);
      }
    }
