...
import { HistogramQuerySetting, HistogramVizSetting, SeriesQuerySetting, SeriesVizSetting } from '@core/domain';
...
export default class HistogramSetting extends Vue {
  private get query(): HistogramQuerySetting {
    return QueryBuilderStoreModule.getQuerySetting() as HistogramQuerySetting;
  }

  private get setting(): HistogramVizSetting {
    return QueryBuilderStoreModule.getSettingBloc().getVizSetting() as HistogramVizSetting;
  }
