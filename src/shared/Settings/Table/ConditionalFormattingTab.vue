...
import { ColorFormatting, DataBarFormatting, IconFormatting, PivotTableVizData, TableColumn, TableVizData, VizSettingData } from '@core/domain';
import { SelectOption } from '@/shared';
import { ChartUtils, ListUtils, MapUtils } from '@/utils';
...
export default class ConditionalFormattingTab extends Vue {
  @Prop({ required: true })
  private readonly options!: PivotTableVizData | TableVizData;
  ...
  private static createSettingAsMap(table: TableColumn, key: SettingKeyType, colorFormatting: any): Map<string, any> {
    const vizData: VizSettingData = {
