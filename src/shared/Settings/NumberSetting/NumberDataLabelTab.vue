<template>
  <PanelHeader header="Data Label" target-id="data-label-tab">
    <div class="data-label-tab">
      ...
      <InputSetting id="prefix-input" :value="prefixText" class="mb-3" label="Prefix" size="full" @onChanged="handlePrefixSaved" />
      <DropdownSetting
      ...
      <InputSetting id="postfix-input" :value="postfixText" class="mb-3" label="Postfix" size="full" @onChanged="handlePostfixSaved" />
      <DropdownSetting
...
import { NumberVizData } from '@core/domain';
...
export default class NumberDataLabelTab extends Vue {
  ...
  private readonly setting!: NumberVizData;
  ...
  private readonly defaultSetting = {
    ...
    prefixFontFamily: 'Barlow',
    prefixColor: '#FFFFFF',
    prefixFontSize: '48px',
    prefixText: '',
    postfixFontFamily: 'Barlow',
    postfixColor: '#FFFFFF',
