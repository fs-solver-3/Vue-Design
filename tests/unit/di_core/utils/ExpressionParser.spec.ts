...
import { DateColumn, DoubleColumn, Expression, Int32Column, StringColumn, TableSchema } from '@core/domain/Model';
...
describe('Expression Parser', () => {
  const columns = [
    ...
    new Int32Column('order_id', 'Order Id'),
    new StringColumn('country', 'Country'),
    new DoubleColumn('total_profit', 'Total Profit', true)
  ];
  const table = new TableSchema('bill', 'db_test', 1, 'Bill', columns, [], []);
