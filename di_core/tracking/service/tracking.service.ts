...
export class TrackingServiceImpl extends TrackingService {
  trackUserProfile(userProfile: UserProfile) {
    ...
    if (userProfile.fullName) properties['full_name'] = userProfile.fullName;
    if (userProfile.firstName) properties['first_name'] = userProfile.firstName;
    if (userProfile.lastName) properties['last_name'] = userProfile.lastName;

    if (userProfile.avatar) properties['avatar_url'] = userProfile.avatar || '';
