...
export class PermissionAdminServiceImpl implements PermissionAdminService {
  ...
  getSupportPermissionGroups(): Promise<PermissionGroup[]> {
    return Promise.resolve([
      SupportPermissionGroups.Permission,
      SupportPermissionGroups.User,
      SupportPermissionGroups.Directory,
      SupportPermissionGroups.Dashboard,
      SupportPermissionGroups.Widget,
      // SupportPermissionGroups.Database,
      SupportPermissionGroups.Setting
    ]);
  }
