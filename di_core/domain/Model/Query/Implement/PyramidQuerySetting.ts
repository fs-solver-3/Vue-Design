...
import { Condition, Equal, Function, getFiltersAndSorts, OrderBy, PyramidVizSetting, QuerySettingType, TableColumn, Zoomable } from '@core/domain/Model';
...
export class PyramidQuerySetting extends QuerySetting<PyramidVizSetting> implements Zoomable, Drilldownable {
  ...
  static fromObject(obj: PyramidQuerySetting): PyramidQuerySetting {
    ...
    return new PyramidQuerySetting(legend, value, filters, sorts, obj.options);
  }
  ...
  buildQueryDrilldown(drilldownData: DrilldownData): PyramidQuerySetting {
    ...
    return new PyramidQuerySetting(newLegend, this.value, drilldownConditions, this.sorts, this.options);
  }
