...
export interface StackSeriesVizData extends SeriesVizData {
  stackingGroup?: StackingGroup;
}
export interface StackingGroup {
  [key: string]: any;
}
export class StackedVizSetting extends VizSetting<StackSeriesVizData> {
  ...
  static fromObject(obj: StackedVizSetting): StackedVizSetting {
    return new StackedVizSetting(obj.options);
  }
  ...
  private toSeriesOptions(options: VizSettingData): VizSettingData {
    const result = {
      ...options
    };
