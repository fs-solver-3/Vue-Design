...
export class SpiderWebVizSetting extends VizSetting {
  ...
  static fromObject(obj: SpiderWebVizSetting): SpiderWebVizSetting {
    return new SpiderWebVizSetting(obj.options);
  }
